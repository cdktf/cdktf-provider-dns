// https://registry.terraform.io/providers/hashicorp/dns/3.4.1/docs/resources/txt_record_set
...
export class TxtRecordSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TxtRecordSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.4.1/docs/resources/txt_record_set#import import section} in the documentation of this resource for the id to use
