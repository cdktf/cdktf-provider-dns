...
# CDKTF prebuilt bindings for hashicorp/dns provider version 3.3.2

This repo builds and publishes the [Terraform dns provider](https://registry.terraform.io/providers/hashicorp/dns/3.3.2/docs) bindings for [CDK for Terraform](https://cdk.tf).
