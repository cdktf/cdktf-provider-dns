// https://registry.terraform.io/providers/hashicorp/dns/3.4.2/docs/resources/mx_record_set
...
export class MxRecordSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MxRecordSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/dns/3.4.2/docs/resources/mx_record_set#import import section} in the documentation of this resource for the id to use
